// const apiUrl = 'http://localhost/master-pesss/API/product/show.php';
  ...
  async function fetchProducts() {
    try {
      const response = await fetch('http://localhost/master-pesss/API/proudcte/show.php'); // Replace 'url/to/your/api' with your actual API endpoint
      ...
      data.forEach(product => {
        ...
        productCard.className = 'your-product-card-class'; // Add your custom product card class
